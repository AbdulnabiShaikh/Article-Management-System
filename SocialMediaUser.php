...
<body>
        ...
        <ul class="nav-list">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                  <a href="SocialMediaUser.php">Socail Networking</a>
    ...
    <!-- <div class="class4">
      ...
      <marquee class="mar">Welcome to the Social Media section!Enjoy Reading , Writing and Learning</marquee>
  
       <h1 class="edit">Social media</h1>
       <!-- <marquee>Welcome to the politics section!Enjoy Reading , Writing and Learning</marquee> -->
       <p >Social media are interactive technologies that facilitate the
        creation and sharing of information, ideas,
        interests, and other forms of expression through virtual communities and networks. Users usually
        access
        social media services through web-based apps on desktops or download services that offer social
        media
        functionality to their mobile devices.
        <br>
        As users engage with these electronic services, they create highly interactive platforms which
        individuals,
        communities, and organizations can share, co-create, discuss, participate, and modify
        user-generated or
        self-curated content posted online.</p>
      </div>
  </div>
</body>
...
$sqlget = "SELECT * FROM textuploads where category = 'socialmedia'";
