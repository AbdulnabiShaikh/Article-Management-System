...
<body>
    ...
    <!-- <div class="class4">
      ...
      <marquee class="mar">Welcome to the Education section!Enjoy Reading , Writing and Learning</marquee>
  
       <h1 class="edit">Education</h1>
       <!-- <marquee>Welcome to the politics section!Enjoy Reading , Writing and Learning</marquee> -->
       <p >Welcome To The Most Informative Place On the Website Where You Will Find Everyting You Are Searching For! Informative Content Regarding New Trends In Education Are Updated Frequently Here So Don't Worry About The Freshness Of Articles. You Will Find All The Fresh Content At One Place Here..</p>
      </div>
  </div>
</body>
...
$sqlget = "SELECT * FROM textuploads where category = 'education'";
